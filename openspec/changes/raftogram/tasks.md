...
- [ ] 1.1 Инициализировать Go-модуль и базовую структуру `cmd/raftogram/main.go` (тонкая сборка) и `internal/` пакетов
- [ ] 1.2 Добавить конфигурацию кластера (node id, Raft bind, gRPC bind, список пиров) с валидацией нечётного кворума
- [ ] 1.3 Подключить zap-логгер и флаги/ENV для конфигурации
