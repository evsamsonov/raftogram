...
- [ ] 3.3 Реализовать снапшот/restore FSM, согласованный со снапшотами Raft
- [ ] 3.4 Юнит-тесты: одинаковый порядок команд даёт идентичное состояние; отказ для oversized payload; два commit с одним `client_message_id` дают одно видимое сообщение
