...
- [x] 5.1 Структурированные логи ключевых переходов (election, snapshot, apply errors) без дублирования error log+return
- [x] 5.2 Минимальная документация запуска: пример конфигурации трёх узлов и порядок старта
